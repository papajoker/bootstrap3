...
<html lang="en">
	<head>
		...
		<!-- CSS
		================================================== -->
		<link href="{{ asset('packages/papajoker/bootstrap3/css/bootstrap.3.css') }}" rel="stylesheet">
		<!--link href="{{ asset('packages/papajoker/bootstrap3/less/bootstrap.less') }}" rel="stylesheet/less"-->
		<!--script src="{{ asset('packages/papajoker/bootstrap3/less-1.3.3.min.js') }}"></script-->
	...
	<body>
		...
		<script src="{{ asset('packages/papajoker/bootstrap3/js/button.js') }}"></script>
		<script src="{{ asset('packages/papajoker/bootstrap3/js/tab.js') }}"></script>
		<script src="{{ asset('packages/papajoker/bootstrap3/js/collapse.js') }}"></script>
		<script src="{{ asset('packages/papajoker/bootstrap3/js/popover.js') }}"></script>
	</body>
</html>
